...
def delete_network_from_csv(host,port,token,UUID,version,file,username,password):
	...
	with open (file) as csvfile:
		...
		for row in entries:
			...
			try:
				if row[3]=='NetworkGroup':
					request = requests.delete("https://{}:{}/api/fmc_config/v{}/domain/{}/object/networkgroups/{}".format(host, port,version,UUID,row[4]), headers=headers, verify=False)		
					...
					request = requests.delete("https://{}:{}/api/fmc_config/v{}/domain/{}/object/hosts/{}".format(host, port,version,UUID,row[4]), headers=headers, verify=False)
					status_code = request.status_code
					resp = request.text
					print("Status code is: "+str(status_code))				
					if (status_code == 429):
					...
					request = requests.delete("https://{}:{}/api/fmc_config/v{}/domain/{}/object/fqdns/{}".format(host, port,version,UUID,row[4]), headers=headers, verify=False)
					status_code = request.status_code
					resp = request.text
					print("Status code is: "+str(status_code))				
					if (status_code == 429):
					...
					request = requests.delete("https://{}:{}/api/fmc_config/v{}/domain/{}/object/networks/{}".format(host, port,version,UUID,row[4]), headers=headers, verify=False)
					status_code = request.status_code
					resp = request.text
					print("Status code is: "+str(status_code))				
					if (status_code == 429):
					...
					request = requests.delete("https://{}:{}/api/fmc_config/v{}/domain/{}/object/ranges/{}".format(host, port,version,UUID,row[4]), headers=headers, verify=False)
					status_code = request.status_code
					resp = request.text
					print("Status code is: "+str(status_code))				
					if (status_code == 429):
					...
					#request = requests.delete("https://{}:{}/api/fdm/v{}/object/networks/{}".format(host, port,version,row[4]), headers=headers, verify=False)	
					ii=12
...
if __name__ == "__main__":
	...
	csvfile="output_network_objects.txt"
